...
<link rel="stylesheet" href="__TMPL__/resource/css/focus.css"/>
...
<div class="container-outer">
	<div class='focus-inner'>
		<div class='focus-tab'>
			<a href="">我的关注(<?php echo ($allcount); ?>)</a>
		...
		<div class='focus-content'>
			<?php if(is_array($list)): foreach($list as $key=>$item): ?><div class='focus-member'>
					<dl>
						<dt>
							<a href="__APP__/Profile?member=<?php echo ($item["focusname"]); ?>">
								<img title="<?php echo ($item["focusname"]); ?>" onerror="this.src='__TMPL__/resource/images/person-default-large.png'" src="__ROOT__/Home/Uploads/<?php echo ($item["focusname"]); ?>_large.png"/>
							</a>
						</dt>
						<dd>
							<h3><a href="__APP__/Profile?member=<?php echo ($item["focusname"]); ?>"><?php echo ($item["focusname"]); ?></a></h3>
							<div><span><?php echo ($item["direction"]); ?></span></div>
						</dd>
					</dl>
