...
<link rel="stylesheet" type="text/css" href="__TMPL__/resource/css/profile.css"/>
	...
	<div id="container-wrap">
		<div class="inner-wrap">
			<div class="personal-card">
				...
				<div id="personal-card-box" class="personal-card-box">
					<form id="person-info" method="post">
						...
						<p class="direction card-info" onmouseover="showEdit(this);" onmouseout="hideEdit(this);">
							<span class='info-tips'>就职方向：</span>
							<span  class="edit-content personal-info" id="direction"><?php echo ($member["direction"]); ?></span>	
			...
			<!-- 添加 -->
			<div class=" members-focus">
					<form>
						<fieldset class='form-focus'>
							<legend class='focus-head'><a id='focushead' href="__APP__/Focus?username=<?php echo ($myself["username"]); ?>">我的关注(<?php echo ($allcount); ?>)</a></legend>
							<div id='focustip'></div>
							<div id='membersfocus'>
							<!-- <?php if(is_array($list)): foreach($list as $key=>$item): ?><div class='focusmember'>
									<a href="__APP__/Profile?member=<?php echo ($item["focusname"]); ?>" target="blank">
										<img title="<?php echo ($item["focusname"]); ?>" onerror="this.src='__TMPL__/resource/images/person-default-middle.png'" src="__ROOT__/Home/Uploads/<?php echo ($item["focusname"]); ?>_middle.png"/>
					...
					<div id="timeline-inner">
						...
						<?php if(is_array($experiences)): foreach($experiences as $key=>$exp): ?><div  class="timeline-content">
								<div value="<?php echo ($i); ?>" class="inner">
									...
									<div class="essay-metas">
										<div class="left">
											作者：<?php echo ($exp["author"]); ?>&nbsp;&nbsp;类型：<?php echo ($exp["type"]); ?>&nbsp;&nbsp;时间：<?php echo ($exp["addtime"]); ?>
										</div>
										<div class="right" name="edit">
											<a  href="__APP__/ExperienceEdit?experienceno=<?php echo ($exp["experienceno"]); ?>">编辑</a>
