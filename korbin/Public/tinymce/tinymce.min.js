...
function(e, t) {
	...
	function() {
		...
		function u(e, t) {
			...
			for (s = e, l = [], c = _.preFilter; s;) { (!n || (r = ct.exec(s))) && (r && (s = s.slice(r[0].length) || s), l.push(i = [])),
				n = !1,
				(r = ut.exec(s)) && (n = r.shift(), i.push({
					value: n,
					type: r[0].replace(lt, " ")
				}), s = s.slice(n.length));
		...
		function g(e) {
			...
			o = _.relative[e[0].type], a = o || _.relative[" "], s = o ? 1 : 0, l = f(function(e) {
				return e === t
			},
			a, !0), c = f(function(e) {
			...
			}]; i > s; s++) if (n = _.relative[e[s].type]) u = [f(p(u), n)];
			else {
		...
		function v(e, t) {
			...
			s = function(r, s, l, c, u) {
				...
				if (g += v, i && v !== g) {
					...
					Z.apply(c, m),
					b && !r && m.length > 0 && g + t.length > 1 && o.uniqueSort(c)
				}
				return b && (W = N, S = C),
				y
			};
		...
		function b(e, t, n, r) {
			...
			return k(e, c)(r, t, !H, n, ht.test(e)),
			n
		}
		function C() {}
		var x, w, _, N, E, k, S, T, R, A, B, L, H, D, M, P, O, I = "sizzle" + -new Date,
		F = window.document,
		z = {},
		W = 0,
		V = 0,
		...
		try {
			Z.apply(X = et.call(F.childNodes), F.childNodes),
		...
		A = o.setDocument = function(n) {
			...
			return r !== B && 9 === r.nodeType && r.documentElement ? (B = r, L = r.documentElement, H = !E(r), z.getElementsByTagName = i(function(e) {
				...
				e.id = I + 0,
				e.appendChild(B.createElement("a")).setAttribute("name", I),
				e.appendChild(B.createElement("i")).setAttribute("name", I),
				L.appendChild(e);
				var t = r.getElementsByName && r.getElementsByName(I).length === 2 + r.getElementsByName(I + 0).length;
				return L.removeChild(e),
				t
				...
				e.firstChild && typeof e.firstChild.getAttribute !== G && "#" === e.firstChild.getAttribute("href")
			}) ? {}: {
				href: function(e) {
			...
			}), _.find.TAG = z.getElementsByTagName ?
			function(e, t) {
			...
			M = [], D = [":focus"], (z.qsa = e(r.querySelectorAll)) && (i(function(e) {
				...
				e.querySelectorAll("[selected]").length || D.push("\\[" + nt + "*(?:checked|disabled|ismap|multiple|readonly|selected|value)"),
				e.querySelectorAll(":checked").length || D.push(":checked")
			}), i(function(e) {
				e.innerHTML = "<input type='hidden' i=''/>",
				e.querySelectorAll("[i^='']").length && D.push("[*^$]=" + nt + "*(?:\"\"|'')"),
				...
				z.disconnectedMatch = P.call(e, "div"),
				P.call(e, "[s!='']:x"),
				M.push("!=", st)
			}), D = new RegExp(D.join("|")), M = M.length && new RegExp(M.join("|")), O = e(L.contains) || L.compareDocumentPosition ?
			function(e, t) {
		...
		o.contains = function(e, t) {
			return (e.ownerDocument || e) !== B && A(e),
			O(e, t)
		},
		o.attr = function(e, t) {
			var n;
			return (e.ownerDocument || e) !== B && A(e),
			H && (t = t.toLowerCase()),
			(n = _.attrHandle[t]) ? n(e) : !H || z.attributes ? e.getAttribute(t) : ((n = e.getAttributeNode(t)) || e.getAttribute(t)) && e[t] === !0 ? t: n && n.specified ? n.value: null
		},
		o.error = function(e) {
		...
		_ = o.selectors = {
			...
			filter: {
				...
				CLASS: function(e) {
					var t = U[e + " "];
					return t || (t = new RegExp("(^|" + nt + ")" + e + "(" + nt + "|$)")) && U(e,
					function(e) {
				...
				CHILD: function(e, t, n, r, i) {
					...
					function(e) {
						...
						if (g) {
							...
							else for (; (d = ++p && d && d[m] || (f = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v: 1 !== d.nodeType) || !++f || (y && ((d[I] || (d[I] = {}))[e] = [W, f]), d !== t)););
							return f -= i,
							f === r || 0 === f % r && f / r >= 0
						}
					}
				...
				PSEUDO: function(e, t) {
					...
					return i[I] ? i(t) : i.length > 1 ? (n = [e, e, "", t], _.setFilters.hasOwnProperty(e.toLowerCase()) ? r(function(e, n) {
						for (var r, o = i(e, t), a = o.length; a--;) r = tt.call(e, o[a]),
						e[r] = !(n[r] = o[a])
					}) : function(e) {
						return i(e, 0, n)
					}) : i
			...
			pseudos: {
				...
				lang: r(function(e) {
					return ft.test(e || "") || o.error("unsupported lang: " + e),
					e = e.replace(xt, wt).toLowerCase(),
					function(t) {
						var n;
						do
		...
		return k = o.compile = function(e, t) {
			...
			o = $[e + " "];
			if (!o) {
				for (t || (t = u(e)), n = t.length; n--;) o = g(t[n]),
		...
		_.setFilters = new C,
		z.sortStable = I.split("").sort(K).join("") === I,
		A(),
		[0, 0].sort(K),
	...
	function(e, n) {
		...
		function l(e, t) {
			var n;
			for (e = e || [], "string" == typeof e && (e = e.split(" ")), t = t || {},
			n = e.length; n--;) t[e[n]] = {};
			return t
		}
		function c(e, t) {
		...
		return c.fn = c.prototype = {
			...
			init: function(e, t) {
				...
				if (i(e)) {
					...
					if (r[1]) for (a = o(e).firstChild; a;) this.add(a),
					a = a.nextSibling;
					else {
			...
			before: function() {
				var e = this;
				return e[0] && e[0].parentNode ? a(e, arguments,
				function(e) {
			...
			replaceWith: function(e) {
				var t = this;
				return t[0] && t[0].parentNode.replaceChild(c(e)[0], t[0]),
				t
			},
			wrap: function(e) {
				return e = c(e)[0],
		...
		u(c, {
			...
			filter: function(e, t, n) {
				return n && (e = ":not(" + e + ")"),
				1 === t.length ? c.find.matchesSelector(t[0], e) ? [t[0]] : [] : c.find.matches(e, t)
			}
		}),
		p({
			parent: function(e) {
		...
		function(e, t) {
			c.fn[e] = function(n) {
				...
				return r[0] && (i = t(r[0], n)),
				i = c(i),
				n && "parentsUntil" !== e ? i.filter(n) : i
			}
		}),
	...
	function() {
		return function(e, t) {
			...
			u, d = "\ufeff";
			for (e = e || {},
			u = ("\\\" \\' \\; \\: ; : " + d).split(" "), l = 0; l < u.length; l++) c[u[l]] = d + l,
			c[d + l] = u[l];
			return {
				toHex: function(e) {
				...
				parse: function(t) {
					function s(e, t) {
						...
						n = h[e + "-top" + t],
						n && (r = h[e + "-right" + t], n == r && (i = h[e + "-bottom" + t], r == i && (o = h[e + "-left" + t], i == o && (h[e + t] = o, delete h[e + "-top" + t], delete h[e + "-right" + t], delete h[e + "-bottom" + t], delete h[e + "-left" + t]))))
					}
					function l(e) {
						var t = h[e],
						n;
					...
					function p(t, n, r, i, o, a) {
						return (o = o || a) ? (o = f(o), "'" + o.replace(/\'/g, "\\'") + "'") : (n = f(n || r || i), !e.allow_script_urls && /(java|vb)script:/i.test(n.replace(/[\s\r\n]+/, "")) ? "": (b && (n = b.call(C, n, "style")), "url('" + n.replace(/\'/g, "\\'") + "')"))
					}
					var h = {},
					m, g, v, y, b = e.url_converter,
					C = e.url_converter_scope || this;
					if (t) {
						for (t = t.replace(/[\u0000-\u001F]/g, ""), t = t.replace(/\\[\"\';:\uFEFF]/g, d).replace(/\"[^\"]+\"|\'[^\']+\'/g,
						function(e) {
							return e.replace(/[;:]/g, d)
						}); m = o.exec(t);) {
							if (g = m[1].replace(a, "").toLowerCase(), v = m[2].replace(a, ""), g && v.length > 0) {
								if (!e.allow_script_urls && ("behavior" == g || /expression\s*\(/.test(v))) continue;
								"font-weight" === g && "700" === v ? v = "bold": ("color" === g || "background-color" === g) && (v = v.toLowerCase()),
								v = v.replace(r, n),
								v = v.replace(i, p),
								h[g] = y ? f(v, !0) : v
							}
							o.lastIndex = m.index + m[0].length
						}
						s("border", ""),
						s("border", "-width"),
						s("border", "-color"),
						...
						s("padding", ""),
						s("margin", ""),
						u("border", "border-width", "border-style", "border-color"),
				...
				serialize: function(e, n) {
					function r(n) {
						var r, o, a, l;
						if (r = t.styles[n]) for (o = 0, a = r.length; a > o; o++) n = r[o],
						l = e[n],
						l !== s && l.length > 0 && (i += (i.length > 0 ? " ": "") + n + ": " + l + ";")
					}
					var i = "",
					o, a;
					if (n && t && t.styles) r("*"),
					...
					a !== s && a.length > 0 && (i += (i.length > 0 ? " ": "") + o + ": " + a + ";");
					return i
				}
			}
		}
	...
	function() {
		...
		function s(e, t, n) {
			...
			if (e = /^((static) )?([\w.]+)(:([\w.]+))?/.exec(e), a = e[3].match(/(^|\.)(\w+)$/i)[2], o = r.createNS(e[3].replace(/\.\w+$/, ""), n), !o[a]) {
				...
				this.onCreate && this.onCreate(e[2], e[3], o[a]),
				void 0;
				t[a] || (t[a] = function() {},
				c = 1),
				o[a] = t[a],
	...
	function(e) {
		function t(n) {
			...
			function u(e) {
				e ? (D[U] = D[V], D[q] = D[W]) : (D[V] = D[U], D[W] = D[q]),
				D.collapsed = F
			}
			function d(e) {
				a(e),
			...
			function _(e, t, r) {
				...
				o == i ? w(D[V], D[W], D[U], D[q]) > 0 && D.collapse(e) : D.collapse(e),
				D.collapsed = x(),
			...
			function N(e) {
				...
				for (t = D[U], i = t.parentNode; i; t = i, i = i.parentNode) {
					if (i == D[V]) return k(t, e); ++n
				}
				for (t = D[V], i = t.parentNode; i; t = i, i = i.parentNode) {
					if (i == D[U]) return S(t, e); ++r
				}
				for (o = r - n, a = D[V]; o > 0;) a = a.parentNode,
				o--;
				for (s = D[U]; 0 > o;) s = s.parentNode,
				o++;
			...
			function E(e) {
				...
				for (o = C(D[V], D[W]), a = D[q] - D[W]; o && a > 0;) s = o.nextSibling,
				l = L(o, e),
				t && t.appendChild(l),
				--a,
				o = s;
				return e != O && D.collapse(F),
				t
			}
			function k(e, t) {
				var n, i, o, a, s, l;
				if (t != I && (n = r()), i = R(e, t), n && n.appendChild(i), o = j(e), a = o - D[W], 0 >= a) return t != O && (D.setEndBefore(e), D.collapse(z)),
				n;
				...
				--a,
				i = s;
				return t != O && (D.setEndBefore(e), D.collapse(z)),
				n
			}
			function S(e, t) {
				var n, i, o, a, s, l;
				for (t != I && (n = r()), o = A(e, t), n && n.appendChild(o), i = j(e), ++i, a = D[q] - i, o = e.nextSibling; o && a > 0;) s = o.nextSibling,
				l = L(o, t),
				n && n.appendChild(l),
				--a,
				o = s;
				return t != O && (D.setStartAfter(e), D.collapse(F)),
				n
			}
			function T(e, t, n) {
				var i, o, a, s, l, c, u, d;
				for (n != I && (o = r()), i = A(e, n), o && o.appendChild(i), a = e.parentNode, s = j(e), l = j(t), ++s, c = l - s, u = e.nextSibling; c > 0;) d = u.nextSibling,
				i = L(u, n),
				o && o.appendChild(i),
				u = d,
				--c;
				return i = R(t, n),
				o && o.appendChild(i),
				n != O && (D.setStartAfter(e), D.collapse(F)),
				o
			}
			function R(e, t) {
				var n = C(D[U], D[q] - 1),
	...
	function(e, n, r, i, o, a, s, l) {
		function c(e, t) {
			...
			i.files = {},
			i.counter = 0,
			i.stdMode = !g || e.documentMode >= 8,
			i.boxModel = !g || "CSS1Compat" == e.compatMode || i.stdMode,
		...
		return c.prototype = {
			...
			clone: function(e, t) {
				var n = this,
				r, i;
				return ! g || 1 !== e.nodeType || t ? e.cloneNode(t) : (i = n.doc, t ? r.firstChild: (r = i.createElement(e.nodeName), u(n.getAttribs(e),
				function(t) {
			...
			getParents: function(e, n, r, i) {
				var o = this,
				a, s = [];
				for (e = o.get(e), i = i === t, r = r || ("BODY" != o.getRoot().nodeName ? o.getRoot().parentNode: null), d(n, "string") && (a = n, n = "*" === n ?
				function(e) {
					return 1 == e.nodeType
				}: function(e) {
					return o.is(e, a)
			...
			add: function(e, t, n, r, i) {
				...
				function(e) {
					var a;
					return a = d(t, "string") ? o.doc.createElement(t) : t,
					o.setAttribs(a, n),
			...
			setStyle: function(e, t, n) {
				...
				function(e) {
					...
					if (t) if ("string" == typeof t) {
						...
						"number" != typeof n || b[t] || (n += "px"),
						"opacity" === t && e.runtimeStyle && "undefined" == typeof e.runtimeStyle.opacity && (i.filter = "" === n ? "": "alpha(opacity=" + 100 * n + ")"),
			...
			getStyle: function(e, n, r) {
				if (e = this.get(e)) {
					...
					"float" == n && (n = g ? "styleFloat": "cssFloat"),
			...
			setAttrib: function(e, t, n) {
				var r = this;
				if (e && t) return this.run(e,
				function(e) {
					var i = r.settings,
					o = e.getAttribute(t);
					if (null !== n) switch (t) {
					case "style":
						if (!d(n, "string")) return u(n,
						function(t, n) {
							r.setStyle(e, n, t)
						}),
						void 0;
			...
			getPos: function(e, t) {
				...
				if (e = n.get(e), t = t || a.body, e) {
					...
					t = n.boxModel ? a.documentElement: a.body,
					r = s.left + (a.documentElement.scrollLeft || a.body.scrollLeft) - t.clientTop,
					i = s.top + (a.documentElement.scrollTop || a.body.scrollTop) - t.clientLeft,
					{
						x: r,
						y: i
					};
					for (o = e; o && o != t && o.nodeType;) r += o.offsetLeft || 0,
					i += o.offsetTop || 0,
					o = o.offsetParent;
					for (o = e.parentNode; o && o != t && o.nodeType;) r -= o.scrollLeft || 0,
					i -= o.scrollTop || 0,
					o = o.parentNode
				}
				return {
			...
			loadCSS: function(e) {
				...
				n = t.doc,
				r;
				return t !== c.DOM && n === document ? (c.DOM.loadCSS(e), void 0) : (e || (e = ""), r = n.getElementsByTagName("head")[0], u(e.split(","),
				function(e) {
					var i;
			...
			hasClass: function(e, t) {
				return e = this.get(e),
				e && t ? -1 !== (" " + e.className + " ").indexOf(" " + t + " ") : !1
			},
			toggleClass: function(e, n, r) {
				r = r === t ? !this.hasClass(e, n) : r,
				this.hasClass(e, n) !== r && (r ? this.addClass(e, n) : this.removeClass(e, n))
			},
			show: function(e) {
			...
			isHidden: function(e) {
				return e = this.get(e),
				!e || "none" == e.style.display || "none" == this.getStyle(e, "display")
			},
			uniqueId: function(e) {
			...
			replace: function(e, t, n) {
				...
				return r.run(t,
				function(t) {
					return d(t, "array") && (e = e.cloneNode(!0)),
					n && u(f(t.childNodes),
					function(t) {
						e.appendChild(t)
					}),
			...
			rename: function(e, t) {
				var n = this,
				r;
				return e.nodeName != t.toUpperCase() && (r = n.create(t), u(n.getAttribs(e),
				function(t) {
					n.setAttrib(r, t.nodeName, n.getAttrib(e, t.nodeName))
				}), n.replace(r, e, 1)),
				r || e
			...
			run: function(e, t, n) {
				...
				e ? (n = n || this, e.nodeType || !e.length && 0 !== e.length ? t.call(n, e) : (i = [], u(e,
				function(e, o) {
	...
	function(e, t) {
		function n() {
			function e(e, t) {
				...
				a.src = e,
				"onreadystatechange" in a ? a.onreadystatechange = function() { / loaded | complete / .test(a.readyState) && n()
				}: a.onload = n,
				a.onerror = i,
			...
			this.loadScripts = function(t, r, l) {
				...
				h = function() {
					...
					i(r,
					function(t) {
						return s[t] == a ? (p(t), void 0) : (s[t] != n && (s[t] = n, d++, e(t,
						function() {
							s[t] = a,
							d--,
							p(t),
	...
	function(e) {
		...
		function n(e) {
			function n(e, n, r) {
				...
				r.push.apply(r, u[l]);
				for (e = t(e), o = e.length; o--;) c = [].concat(s, t(n)),
				a[e[o]] = {
					attributes: i(c),
					attributesOrder: c,
					children: i(r)
		...
		return function(e) {
			function c(t, n, o) {
				var s = e[t];
				return s ? s = i(s, ",", i(s.toUpperCase(), " ")) : (s = r[t], s || (s = i(n, " ", i(n.toUpperCase(), " ")), s = a(s, o), r[t] = s)),
				s
			}
			function u(e) {
			...
			function d(e) {
				...
				if (e) for (e = t(e, ","), v["@"] && (w = v["@"].attributes, _ = v["@"].attributesOrder), n = 0, r = e.length; r > n; n++) if (s = k.exec(e[n])) {
					...
					if (f) for (f = t(f, "|"), o = 0, a = f.length; a > o; o++) if (s = S.exec(f[o])) {
						if (d = {},
						m = s[1], h = s[2].replace(/::/g, ":"), C = s[3], E = s[4], "!" === m && (c.attributesRequired = c.attributesRequired || [], c.attributesRequired.push(h), d.required = !0), "-" === m) {
							delete g[h],
							y.splice(l(y, h), 1);
							continue
						}
						C && ("=" === C && (c.attributesDefault = c.attributesDefault || [], c.attributesDefault.push({
							...
							name: h,
							value: E
						}), d.forcedValue = E), "<" === C && (d.validValues = i(E, "?"))),
						T.test(h) ? (c.attributePatterns = c.attributePatterns || [], d.pattern = u(h), c.attributePatterns.push(d)) : (g[h] || y.push(h), g[h] = d)
					}
					w || "@" != p || (w = g, _ = y),
					x && (c.outputName = p, v[x] = c),
					T.test(p) ? (c.pattern = u(p), b.push(c)) : v[p] = c
				}
			}
			function f(e) {
				v = {},
			...
			function p(e) {
				...
				function(e) {
					...
					i = r ? "span": "div",
					s = t[2];
					if (y[s] = y[i], R[s] = i, r || (k[s.toUpperCase()] = {},
					k[s] = {}), !v[s]) {
						var l = v[i];
						l = a({},
						l),
						delete l.removeEmptyAttrs,
						delete l.removeEmpty,
						v[s] = l
					}
					o(y,
					function(e) {
			...
			S = c("non_empty_elements", "td th iframe video audio object", N),
			T = c("text_block_elements", "h1 h2 h3 h4 h5 h6 p div address pre form blockquote center dir fieldset header footer article section hgroup aside nav figure"),
			k = c("block_elements", "hr table tbody thead tfoot th tr td li ol ul caption dl dt dd noscript menu isindex samp option datalist select optgroup", T),
			o((e.special || "script noscript style textarea").split(" "),
			function(e) {
				A[e] = new RegExp("</" + e + "[^>]*>", "gi")
			}),
			e.valid_elements ? f(e.valid_elements) : (o(x,
			function(e, t) {
				v[t] = {
				...
				y[t] = e.children
			}), "html5" != e.schema && o(t("strong/b em/i"),
			function(e) {
				e = t(e, "/"),
				v[e[1]].outputName = e[0]
			}), v.img.attributesDefault = [{
				name: "alt",
				value: ""
			}], o(t("ol ul sub sup blockquote span font a table tbody tr strong em b i"),
			function(e) {
				v[e] && (v[e].removeEmpty = !0)
			}), o(t("p h1 h2 h3 h4 h5 h6 th td pre div address caption"),
			function(e) {
				v[e].paddEmpty = !0
			}), o(t("span"),
			function(e) {
			...
			h("+ol[ul|ol],+ul[ul|ol]"),
			e.invalid_elements && o(s(e.invalid_elements),
			function(e) {
				v[e] && delete v[e]
			}),
			m("span") || d("span[!data-mce-type|*]"),
			g.children = y,
			g.styles = C,
			g.getBoolAttrs = function() {
				return E
			},
			...
			g.getElementRule = m,
			g.getCustomElements = function() {
				return R
			},
			g.addValidElements = d,
			g.setValidElements = f,
			g.addCustomElements = p,
			g.addValidChildren = h,
			g.elements = v
		}
	}),
	r(w, [x, m, p],
		...
		return function(i, o) {
			...
			a.parse = function(e) {
				function r(e) {
					...
					if (t >= 0) {
						for (n = f.length - 1; n >= t; n--) e = f[n],
						e.valid && s.end(e.name);
						f.length = t
					}
				}
				function a(e, t, n, r, o) {
					...
					W[t] && !i.allow_script_urls && /(java|vb)script:/i.test(decodeURIComponent(n.replace(l, ""))) || (p.map[t] = n, p.push({
						name: t,
						value: n
					}))
				}
				...
				for (D = new RegExp("<(?:(?:!--([\\w\\W]*?)-->)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([^>]+)>)|(?:([A-Za-z0-9\\-\\:\\.]+)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), M = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, b = o.getShortEndedElements(), H = i.self_closing_elements || o.getSelfClosingElements(), C = o.getBoolAttrs(), w = i.validate, y = i.remove_internals, z = i.fix_self_closing, P = o.getSpecialElements(); l = D.exec(e);) {
					if (c < l.index && s.text(F(e.substr(c, l.index - c))), u = l[6]) u = u.toLowerCase(),
					...
					r(u);
						...
						if (u = u.toLowerCase(), ":" === u.charAt(0) && (u = u.substr(1)), x = u in b, z && H[u] && f.length > 0 && f[f.length - 1].name === u && r(u), !w || (_ = o.getElementRule(u))) {
							if (N = !0, w && (S = _.attributes, T = _.attributePatterns), (k = l[8]) ? (v = -1 !== k.indexOf("data-mce-type"), v && y && (N = !1), p = [], p.map = {},
							k.replace(M, a)) : (p = [], p.map = {}), w && !v) {
								if (R = _.attributesRequired, A = _.attributesDefault, B = _.attributesForced, L = _.removeEmptyAttrs, L && !p.length && (N = !1), B) for (h = B.length; h--;) E = B[h],
								g = E.name,
								O = E.value,
								"{$uid}" === O && (O = "mce_" + I++),
								p.map[g] = O,
								...
								if (A) for (h = A.length; h--;) E = A[h],
								g = E.name,
								g in p.map || (O = E.value, "{$uid}" === O && (O = "mce_" + I++), p.map[g] = O, p.push({
									name: g,
									value: O
								}));
								if (R) {
						...
						if (d = P[u]) {
							d.lastIndex = c = l.index + l[0].length,
							(l = d.exec(e)) ? (N && (m = e.substr(c, l.index - c)), c = l.index + l[0].length) : (m = e.substr(c), c = e.length),
							N && (m.length > 0 && s.text(m, !0), s.end(u)),
							D.lastIndex = c;
							continue
						}
				...
				for (c < e.length && s.text(F(e.substr(c))), h = f.length - 1; h >= 0; h--) u = f[h],
				u.valid && s.end(u.name)
			}
		}
	}),
	r(_, [C, x, w, p],
	function(e, t, n, r) {
		...
		return function(r, l) {
			...
			u.parse = function(t, o) {
				...
				function m(e) {
					var t, n, r;
					for (t = e.prev; t && 3 === t.type;) n = t.value.replace(L, ""),
				...
				T = s(i("script,style,head,html,body,title,meta,param"), l.getBlockElements()), O = l.getNonEmptyElements(), P = l.children, S = r.validate, I = "forced_root_block" in o ? o.forced_root_block: r.forced_root_block, M = l.getWhiteSpaceElements(), R = /^[ \t\r\n]+/, L = /[ \t\r\n]+$/, H = /[ \t\r\n]+/g, D = /^[ \t\r\n]+$/, v = new n({
					...
					text: function(e, t) {
						var n;
						B || (e = e.replace(H, " "), b.lastChild && T[b.lastChild.name] && (e = e.replace(R, ""))),
					...
					start: function(e, t, n) {
						...
						if (r = S ? l.getElementRule(t) : {}) {
							if (T[t] && !B) {
								...
								o = n.next,
								(0 === i.length || D.test(i)) && (n.remove(), n = o),
								n = o;
	...
	function(e, t, n, r, i, o, a, s) {
		...
		return function(e, i) {
			...
			f.addAttributeFilter("data-mce-expando",
			function(e, t) {
			...
			function(e, t) {
				...
				for (var r = e.length,
				i, o; r--;) if (i = e[r], o = i.firstChild ? i.firstChild.value: "", "script" === t) {
					var a = (i.attr("type") || "text/javascript").replace(/^mce\-/, "");
					i.attr("type", "text/javascript" === a ? null: a),
			...
			f.addAttributeFilter("data-mce-src,data-mce-href,data-mce-style,data-mce-selected",
			function(e, t) {
				for (var n = e.length; n--;) e[n].attr(t, null)
			}),
			{
		...
		function e(e) {
			...
			function n() {
				function n(e) {
					...
					void 0;
					if (i === c) return a[e ? "setStartBefore": "setEndAfter"](r),
					void 0;
					if (n.position < 0) {
	...
	function(e, t, n) {
		return function(r, i) {
			...
			function a(t) {
				...
				D = 5 > D ? 5 : D,
				M = 5 > M ? 5 : M,
				(e.modifierPressed(t) || "IMG" == x.nodeName && 0 !== N[2] * N[3]) && (D = Math.round(M / L), M = Math.round(D * L)),
				b.setStyles(w, {
					width: D,
					height: M
				}),
				N[2] < 0 && w.clientWidth <= D && b.setStyle(w, "left", T + (A - D)),
				N[3] < 0 && w.clientHeight <= M && b.setStyle(w, "top", R + (B - M)),
			...
			function s() {
				...
				e("width", D),
				e("height", M),
				b.unbind(P, "mousemove", a),
				b.unbind(P, "mouseup", s),
				O != P && (b.unbind(O, "mousemove", a), b.unbind(O, "mouseup", s)),
				b.remove(w),
				I && "TABLE" != x.nodeName || l(x),
			...
			function l(e, t, n) {
				...
				l = f.width || f.right - f.left,
				u = f.height || f.bottom - f.top,
				x != e && (m(), x = e, D = M = 0),
				d = i.fire("ObjectSelected", {
					target: e
				}),
				o(e) && !d.isDefaultPrevented() ? C(_,
				function(e, r) {
					function o(t) {
						H = !0,
						k = t.screenX,
						...
						N = e,
						w = x.cloneNode(!0),
						b.addClass(w, "mce-clonedresizable"),
						w.contentEditable = !1,
						w.unSelectabe = !0,
						b.setStyles(w, {
							left: T,
						...
						w.removeAttribute("data-mce-selected"),
						i.getBody().appendChild(w),
						b.bind(P, "mousemove", a),
						b.bind(P, "mouseup", s),
						O != P && (b.bind(O, "mousemove", a), b.bind(O, "mouseup", s))
					}
					var c, d;
				...
				x.setAttribute("data-mce-selected", "1")
			}
			function c() {
				var e, t;
				x && x.removeAttribute("data-mce-selected");
				for (e in _) t = b.get("mceResizeHandle" + e),
				t && (b.unbind(t), b.remove(t))
			}
			function u(e) {
				function t(e, t) {
					do
				...
				var n;
				return C(b.select("img[data-mce-selected],hr[data-mce-selected]"),
				function(e) {
					e.removeAttribute("data-mce-selected")
				}),
				n = "mousedown" == e.type ? e.target: r.getNode(),
				n = b.getParent(n, I ? "table": "table,img,hr"),
				n && (g(), t(r.getStart(), n) && t(r.getEnd(), n) && (!I || n != r.getStart() && "IMG" !== r.getStart().nodeName)) ? (l(n), void 0) : (c(), void 0)
			}
			function d(e, t, n) {
			...
			function h(e) {
				var t = e.srcElement;
				if (t != x) {
					if (m(), 0 === t.id.indexOf("mceResizeHandle")) return e.returnValue = !1,
					void 0; ("IMG" == t.nodeName || "TABLE" == t.nodeName) && (c(), x = t, d(t, "resizestart", p))
				}
			}
			function m() {
				f(x, "resizestart", p)
			...
			function y() {
				x = w = null,
				I && (m(), f(i.getBody(), "controlselect", h))
			}
			var b = i.dom,
			C = t.each,
			x, w, _, N, E, k, S, T, R, A, B, L, H, D, M, P = i.getDoc(),
			O = document,
			I = n.ie && n.ie < 11;
			_ = {
				n: [.5, 0, 0, -1],
			...
			return i.contentStyles.push(F + " div.mce-resizehandle {" + "position: absolute;" + "border: 1px solid black;" + "background: #FFF;" + "width: 5px;" + "height: 5px;" + "z-index: 10000" + "}" + F + " .mce-resizehandle:hover {" + "background: #000" + "}" + F + " img[data-mce-selected], hr[data-mce-selected] {" + "outline: 1px solid black;" + "resize: none" + "}" + F + " .mce-clonedresizable {" + "position: absolute;" + (n.gecko ? "": "outline: 1px dashed black;") + "opacity: .5;" + "filter: alpha(opacity=50);" + "z-index: 10000" + "}"),
			i.on("init",
			function() {
				I ? (i.on("ObjectResized",
				function(e) {
					"TABLE" != e.target.nodeName && (c(), v(e.target))
				}), d(i.getBody(), "controlselect", h), i.on("mousedown",
				function(e) {
					E = e
				})) : (g(), n.ie >= 11 && (i.on("mouseup",
				function(e) {
					var t = e.target.nodeName;
					/^(TABLE|IMG|HR)$/.test(t) && (i.selection.select(e.target, "TABLE" == t), i.nodeChanged())
				}), i.dom.bind(i.getBody(), "mscontrolselect",
				function(e) { / ^(TABLE | IMG | HR) $ / .test(e.target.nodeName) && e.preventDefault()
				}))),
				i.on("nodechange mousedown mouseup ResizeEditor", u),
				i.on("keydown keyup",
				function(e) {
	...
	function(e, n, r, i, o) {
		...
		return a.prototype = {
			...
			getStart: function() {
				...
				return n = t.startContainer,
				1 == n.nodeType && n.hasChildNodes() && (n = n.childNodes[Math.min(n.childNodes.length - 1, t.startOffset)]),
			...
			getBookmark: function(e, t) {
				...
				function i() {
					...
					r = a.getRoot(),
					i = {};
					return i.start = e(n, !0),
					o.isCollapsed() || (i.end = e(n)),
					i
				}
				var o = this,
				a = o.dom,
				...
				if (l = o.getRng(), u = a.uniqueId(), d = o.isCollapsed(), m = "overflow:hidden;line-height:0px", l.duplicate || l.item) {
					...
					c = r(l.cloneRange()),
					d || (c.collapse(!1), c.insertNode(a.create("span", {
			...
			moveToBookmark: function(e) {
				function t(t) {
					...
					if (n) {
						...
						3 === i.nodeType && (o = Math.min(n[0], i.nodeValue.length)),
						1 === i.nodeType && (o = Math.min(n[0], i.childNodes.length)),
				...
				function n(t) {
					...
					if (n && (r = n.parentNode, "start" == t ? (u ? (r = n.firstChild, i = 1) : i = o.nodeIndex(n), f = p = r, h = m = i) : (u ? (r = n.firstChild, i = 1) : i = o.nodeIndex(n), p = r, m = i), !u)) {
						for (c = n.previousSibling, a = n.nextSibling, s(l(n.childNodes),
						function(e) {
			...
			select: function(t, n) {
				...
				if (i.lastFocusBookmark = null, l = o.schema.getNonEmptyElements(), t) {
					...
					s = o.nodeIndex(t),
					a.setStart(t.parentNode, s),
					a.setEnd(t.parentNode, s + 1),
					n && (r(t, 1), r(t)),
					i.setRng(a)
				}
				return t
			...
			getRng: function(e) {
				...
				if (!e && t.lastFocusBookmark) {
					...
					return s.startContainer ? (r = o.createRange(), r.setStart(s.startContainer, s.startOffset), r.setEnd(s.endContainer, s.endOffset)) : r = s,
					r
				}
				if (e && t.tridentSel) return t.tridentSel.getRangeAt(0);
				try { (n = t.getSel()) && (r = n.rangeCount > 0 ? n.getRangeAt(0) : n.createRange ? n.createRange() : o.createRange())
				} catch(l) {}
				if (u && r && r.setStart) {
					try {
				...
				r.setStart && 9 === r.startContainer.nodeType && r.collapsed && (i = t.dom.getRoot(), r.setStart(i, 0), r.setEnd(i, 0)),
				t.selectedRange && t.explicitRange && (0 === r.compareBoundaryPoints(r.START_TO_START, t.selectedRange) && 0 === r.compareBoundaryPoints(r.END_TO_END, t.selectedRange) ? r = t.explicitRange: (t.selectedRange = null, t.explicitRange = null)),
				r
			},
			setRng: function(e, t) {
				var n = this,
				...
				if (e.select) try {
					...
					if (e.cloneRange) try {
						return n.tridentSel.addRange(e),
						void 0
					} catch(i) {}
				} else if (r = n.getSel()) {
					n.explicitRange = e;
				...
				function t(t) {
					...
					function l(t, n) {
						...
						for (n = n || c, r = new e(n, f.getParent(n.parentNode, f.isBlock) || p); h = r[t ? "prev": "next"]();) {
							if (3 === h.nodeType && h.nodeValue.length > 0) return c = h,
							u = t ? h.nodeValue.length: 0,
							i = !0,
							void 0;
					...
					o && (3 === c.nodeType && 0 === u && l(!0), 1 === c.nodeType && (h = c.childNodes[u], !h || "BR" !== h.nodeName || s(h, "A") || a(h) || a(h, !0) || l(!0, c.childNodes[u]))),
					t && !o && 3 === c.nodeType && u === c.nodeValue.length && l(!1),
					i && r["set" + (t ? "Start": "End")](c, u)
				}
				var n = this,
				r, i, o;
			...
			selectorChanged: function(e, t) {
				...
				function(e) {
					...
					a = {};
					s(n.selectorChangedData,
					function(e, t) {
						s(o,
						function(n) {
							return i.is(n, t) ? (r[t] || (s(e,
							function(e) {
								e(!0, {
									node: n,
									selector: t,
			...
			scrollIntoView: function(e) {
				...
				if ("BODY" != a.nodeName) {
					...
					l = c.clientHeight,
					s = c.scrollTop,
					(s > n || n + 25 > s + l) && (c.scrollTop = s > n ? n: n - l + 25),
					void 0
				}
		...
		function t(e) {
			this.walk = function(t, r) {
				function i(e) {
					var t;
					return t = e[0],
					3 === t.nodeType && t === l && c >= t.nodeValue.length && e.splice(0, 1),
					t = e[e.length - 1],
					0 === d && e.length > 0 && t === u && 3 === t.nodeType && e.splice(e.length - 1, 1),
					e
				}
				function o(e, t, n) {
				...
				function s(e, t, n) {
					...
					for (m = e, g = m.parentNode; m && m != t; m = g) g = m.parentNode,
					v = o(m == e ? m: m[a], a),
				...
				d = t.endOffset,
				f, p, h, m, g, v, y;
				if (y = e.select("td.mce-item-selected,th.mce-item-selected"), y.length > 0) return n(y,
				function(e) {
					r([e])
				}),
				void 0;
				...
				h = a(u, f) || u,
				s(l, p, !0),
				v = o(p == l ? p: p.nextSibling, "nextSibling", h == u ? h.nextSibling: h),
				v.length && r(i(v)),
				s(u, h)
			},
	...
	function(e, t, n) {
		return function(r) {
			function i(e) {
				...
				!!r.schema.getTextBlockElements()[e.toLowerCase()]
			}
			function o(e, t) {
			...
			function s() {
				...
				et("p h1 h2 h3 h4 h5 h6 div address pre div dt dd samp".split(/\s/),
				function(e) {
					u(e, {
						block: e,
						remove: "all"
			...
			function u(e, t) {
				e && ("string" != typeof e ? et(e,
				function(e, t) {
					u(t, e)
				}) : (t = t.length ? t: [t], et(t,
				function(e) {
					e.deep === X && (e.deep = !e.selector),
					e.split === X && (e.split = !e.selector || e.inline),
					e.remove === X && e.selector && !e.inline && (e.remove = "none"),
			...
			function d(e) {
				var t;
				return r.dom.getParent(e,
				function(e) {
					return t = r.dom.getStyle(e, "text-decoration"),
					t && "none" !== t
				}),
				t
			}
			...
			function p(t, n, o) {
				function s(e, t) {
					t = t || m,
					e && (t.onformat && t.onformat(e, t, n, o), et(t.styles,
					function(t, r) {
				...
				function u(e, t, n, r, i) {
					...
					0 >= a || a > l && c > a ? (et(tt(e.childNodes), i), 0) : (u = I.clone(n, K), et(tt(e.childNodes),
					function(e, t) { (a > l && a > t || l > a && t > a) && (o.push(e), e.parentNode.removeChild(e))
					}), a > l ? e.insertBefore(u, s) : l > a && e.insertBefore(u, s.nextSibling), r.push(u), et(o,
					function(e) {
						u.appendChild(e)
					}), u)
				}
				function d(e, r, o) {
					...
					function(e) {
						function p(e) {
							...
							C = e.parentNode.nodeName.toLowerCase(),
							1 === e.nodeType && J(e) && (N = f, f = "true" === J(e), _ = !0),
							w(y, "br") ? (v = 0, m.block && I.remove(e), void 0) : m.wrapper && g(e, t, n) ? (v = 0, void 0) : f && !_ && m.block && !m.wrapper && i(y) && W(C, c) ? (e = I.rename(e, c), s(e), l.push(e), v = 0, void 0) : m.selector && (et(h,
							function(t) {
					...
					function(e) {
						...
						var o;
						if (o = r(e), (l.length > 1 || !V(e)) && 0 === o) return I.remove(e, 1),
						void 0;
						if (m.inline || m.wrapper) {
							if (m.exact || 1 !== o || (e = i(e)), et(h,
							function(t) {
								et(I.select(t.inline, e),
								function(e) {
									var r;
									if (t.wrap_links === !1) {
										r = e.parentNode;
							...
							}), g(e.parentNode, t, n)) return I.remove(e, 1),
							e = 0,
							G;
							m.merge_with_parents && I.getParent(e.parentNode,
							function(r) {
				...
				y,
				b = !o && F.isCollapsed();
				if (m) if (o) o.nodeType ? (y = I.createRng(), y.setStartBefore(o), y.setEndAfter(o), d(T(y, h), null, !0)) : d(o, null, !0);
				else if (b && m.inline && !I.select("td.mce-item-selected,th.mce-item-selected").length) M("apply", t, n);
				else {
					var C = r.selection.getNode();
					U || !h[0].defaultBlock || I.getParent(C, I.isBlock) || p(h[0].defaultBlock),
					r.selection.setRng(l()),
					v = F.getBookmark(),
					d(T(F.getRng(G), h), v),
					m.styles && (m.styles.color || m.styles.textDecoration) && (nt(C, f, "childNodes"), f(C)),
					F.moveToBookmark(v),
					P(F.getRng(G)),
					r.nodeChanged()
				}
			...
			function h(e, t, n) {
				...
				function a(n) {
					var r;
					return et(o(n.parentNode).reverse(),
					function(n) {
						var i;
				...
				function u(e) {
					...
					return L(n) && (n = n[e ? "firstChild": "lastChild"]),
					I.remove(t, !0),
					n
				}
				function f(e) {
					...
					e = T(e, p, G),
					h.split && (t = D(e, G), n = D(e), t != n ? (/^(TR|TH|TD)$/.test(t.nodeName) && t.firstChild && (t = "TR" == t.nodeName ? t.firstChild.firstChild || t: t.firstChild || t), o && /^T(HEAD|BODY|FOOT|R)$/.test(o.nodeName) && /^(TH|TD)$/.test(n.nodeName) && n.firstChild && (n = n.firstChild || n), t = S(t, "span", {
						id: "_start",
						"data-mce-type": "bookmark"
					}), n = S(n, "span", {
						id: "_end",
						"data-mce-type": "bookmark"
					}), l(t), l(n), t = u(G), n = u()) : t = n = l(t), e.startContainer = t.parentNode, e.startOffset = q(t), e.endContainer = n.parentNode, e.endOffset = q(n) + 1),
					z.walk(e,
					function(e) {
						et(e,
						function(e) {
							i(e),
							1 === e.nodeType && "underline" === r.dom.getStyle(e, "text-decoration") && e.parentNode && "underline" === d(e.parentNode) && R({
								deep: !1,
								exact: !0,
								inline: "span",
								styles: {
			...
			function m(e, t, n) {
				var r = c(e); ! v(e, t, n) || "toggle" in r[0] && !r[0].toggle ? p(e, t, n) : h(e, t, n)
			}
			function g(e, t, n, r) {
				function i(e, t, i) {
					var o, a, s = t[i],
			...
			function N(e, t) {
				return ("color" == t || "backgroundColor" == t) && (e = I.toHex(e)),
			...
			function T(t, n, a) {
				...
				function u(t, n, i) {
					function o(e, t) {
						...
						return "undefined" == typeof t && (t = i ? o.length: 0),
						i ? (n = o.lastIndexOf(" ", t), r = o.lastIndexOf("\xa0", t), n = n > r ? n: r, -1 === n || a || n++) : (n = o.indexOf(" ", t), r = o.indexOf("\xa0", t), n = -1 !== n && ( - 1 === r || r > n) ? n: r),
						n
					}
					var s, l, c, u;
					if (3 === t.nodeType) {
				...
				function f(e, t) {
					var r, a = I.getRoot();
					if (n[0].wrapper || (r = I.getParent(e, n[0].block)), r || (r = I.getParent(3 == e.nodeType ? e.parentNode: e,
					function(e) {
						return e != a && i(e)
				...
				return (n[0].inline || n[0].block_expand) && (n[0].inline && 3 == g.nodeType && 0 !== v || (g = s(!0)), n[0].inline && 3 == y.nodeType && b !== y.nodeValue.length || (y = s())),
				n[0].selector && n[0].expand !== K && !n[0].inline && (g = d(g, "previousSibling"), y = d(y, "nextSibling")),
				(n[0].block || n[0].selector) && (g = f(g, "previousSibling"), y = f(y, "nextSibling"), n[0].block && (V(g) || (g = s(!0)), V(y) || (y = s()))),
			...
			function R(e, t, n, r) {
				...
				function(e, i) {
					...
					if (e = E(e, t), "number" == typeof i && (i = e, r = 0), !r || w(I.getAttrib(r, i), e)) {
						...
						function m() {
							...
							F.moveToBookmark(s);
								...
								v && I.isEmpty(v) ? d.parentNode.replaceChild(m, d) : I.insertAfter(m, d),
								F.setCursorLocation(u, 1),
								I.isEmpty(d) && I.remove(d)
							}
						}
						function v() {
							var e;
						...
						var y = "_mce_caret",
						b = r.settings.caret_debug; r._hasCaretEvents || (Z = function() {
							var e = [],
							t;
					...
					function P(t) {
						...
						r = t.startOffset,
						i, o, a, s, l;
						if (3 == n.nodeType && r >= n.nodeValue.length && (r = q(n), n = n.parentNode, i = !0), 1 == n.nodeType) for (s = n.childNodes, n = s[Math.min(r, s.length - 1)], o = new e(n, I.getParent(n, I.isBlock)), (r > s.length - 1 || i) && o.next(), a = o.current(); a; a = o.next()) if (3 == a.nodeType && !k(a)) return l = I.create("a", null, $),
					...
					I = r.dom,
					F = r.selection,
					z = new t(I), W = r.schema.isValidChild, V = I.isBlock, U = r.settings.forced_root_block, q = I.nodeIndex, $ = "\ufeff", j = /^(src|href|style)$/, K = !1, G = !0, Y, X, J = I.getContentEditable, Q, Z, et = n.each, tt = n.grep, nt = n.walk, rt = n.extend; rt(this, {
						get: c,
						register: u,
						apply: p,
						remove: h,
						...
						canApply: b,
						formatChanged: C
					}), s(), l(), r.on("BeforeGetContent",
					function() {
						Z && Z()
					}), r.on("mouseup keydown",
					function(e) {
						Q && Q(e)
					})
				}
			...
			function(e, t) {
				...
				function(t) {
					...
					t.on("SaveContent ObjectResized", o),
					t.dom.bind(t.dom.getRoot(), "dragend", o),
					t.dom.bind(t.getBody(), "focusout",
					function() { ! t.removed && a.typing && o()
					}),
					t.on("KeyUp",
					function(n) {
						var r = n.keyCode; (r >= 33 && 36 >= r || r >= 37 && 40 >= r || 45 == r || 13 == r || n.ctrlKey) && (o(), t.nodeChanged()),
						(46 == r || 8 == r || e.mac && (91 == r || 93 == r)) && t.nodeChanged(),
						u && a.typing && (t.isDirty() || (t.isNotDirty = !l[0] || i() == l[0].content, t.isNotDirty || t.fire("change", {
							level: l[0],
							lastLevel: null
					...
					t.on("AddUndo Undo Redo ClearUndos MouseUp",
					function(e) {
					...
					a = {
						...
						add: function(e) {
							...
							o;
							if (e = e || {},
							e.content = i(), d || t.fire("BeforeAddUndo", {
								level: e
							...
							return t.fire("AddUndo", a),
							s > 0 && (t.fire("change", a), t.isNotDirty = !1),
							e
						},
						undo: function() {
							var e;
							return a.typing && (a.add(), a.typing = !1),
							s > 0 && (e = l[--s], 0 === s && (t.isNotDirty = !0), t.setContent(e.content, {
								format: "raw"
				...
				return function(t) {
					function r(r) {
						...
						function f(e) {
							...
							!t.hasChildNodes() || t.firstChild == t.lastChild && "" === t.firstChild.nodeValue ? i.remove(t) : "A" == t.nodeName && " " === (t.innerText || t.textContent) && i.remove(t)
						}
						function p(t) {
							function n(e) {
								for (; e;) {
							...
							if ("LI" == t.nodeName) {
								...
								d && /^(UL|OL)$/.test(d.nodeName) && t.insertBefore(i.doc.createTextNode("\xa0"), t.firstChild)
							}
							if (s = i.createRng(), t.hasChildNodes()) {
								for (r = new e(t, t); a = r.current();) {
									if (3 == a.nodeType) {
										s.setStart(a, 0),
										s.setEnd(a, 0);
										break
								...
								a || (s.setStart(l, 0), s.setEnd(l, 0))
							} else "BR" == t.nodeName ? t.nextSibling && i.isBlock(t.nextSibling) ? ((!A || 9 > A) && (u = i.create("br"), t.parentNode.insertBefore(u, t)), s.setStartBefore(t), s.setEndBefore(t)) : (s.setStartAfter(t), s.setEndAfter(t)) : (s.setStart(t, 0), s.setEnd(t, 0));
							o.setRng(s),
							i.remove(u),
							o.scrollIntoView(t)
						}
						function h(e) {
							var t = a.forced_root_block;
							t && t.toLowerCase() === e.tagName.toLowerCase() && i.setAttribs(e, a.forced_root_block_attrs)
						}
						function m(e) {
							var t = S,
							r, o, s;
							if (e || "TABLE" == M ? (r = i.create(e || O), h(r)) : r = R.cloneNode(!1), s = r, a.keep_styles !== !1) do
							if (/^(SPAN|STRONG|B|EM|I|FONT|STRIKE|U)$/.test(t.nodeName)) {
								if ("_mce_caret" == t.id) continue;
								o = t.cloneNode(!1),
								i.setAttrib(o, "id", ""),
								r.hasChildNodes() ? (o.appendChild(r.firstChild), r.appendChild(o)) : (s = o, r.appendChild(o))
							}
							while (t = t.parentNode);
							return n || (s.innerHTML = '<br data-mce-bogus="1">'),
							r
						}
						function g(t) {
							var n, r, i;
							if (3 == S.nodeType && (t ? T > 0 : T < S.nodeValue.length)) return ! 1;
						...
						function v(e, n) {
							...
							if (o = i.getParent(e, i.isBlock), d = t.getBody().nodeName.toLowerCase(), !o || !u(o)) {
								...
								for (; s && !i.isBlock(s);) a = s,
								s = s.previousSibling;
								if (a && l.isValidChild(d, f.toLowerCase())) {
									for (r = i.create(f), h(r), a.parentNode.insertBefore(r, a), s = a; s && !i.isBlock(s);) c = s.nextSibling,
									r.appendChild(s),
									s = c;
									N.setStart(e, n),
									N.setEnd(e, n)
						...
						function y() {
							...
							/^(OL|UL|LI)$/.test(n) && (O = "LI"),
							L = O ? m(O) : i.create("BR"),
							e(!0) && e() ? "LI" == n ? i.insertAfter(L, t()) : i.replace(L, D) : e(!0) ? "LI" == n ? (i.insertAfter(L, t()), L.appendChild(i.doc.createTextNode(" ")), L.appendChild(D)) : D.parentNode.insertBefore(L, D) : e() ? (i.insertAfter(L, t()), d(L)) : (D = t(), E = N.cloneRange(), E.setStartAfter(R), E.setEndAfter(D), H = E.extractContents(), "LI" == O && "LI" == H.firstChild.nodeName ? (L = H.firstChild, i.insertAfter(H, D)) : (i.insertAfter(H, D), i.insertAfter(L, D))),
							i.remove(R),
							p(L),
							s.add()
						}
						function b() {
							for (var t = new e(S, R), n; n = t.next();) if (c[n.nodeName.toLowerCase()] || n.length > 0) return ! 0
						}
						function C() {
							var e, t, r;
							S && 3 == S.nodeType && T >= S.nodeValue.length && (n || b() || (e = i.create("br"), N.insertNode(e), N.setStartAfter(e), N.setEndAfter(e), t = !0)),
							e = i.create("br"),
							N.insertNode(e),
							n && "PRE" == M && (!A || 8 > A) && e.parentNode.insertBefore(i.doc.createTextNode("\r"), e),
							r = i.create("span", {},
							"&nbsp;"),
							e.parentNode.insertBefore(r, e),
							o.scrollIntoView(r),
							i.remove(r),
							t ? (N.setStartBefore(e), N.setEndBefore(e)) : (N.setStartAfter(e), N.setEndAfter(e)),
							o.setRng(N),
							s.add()
						}
						function x(e) {
						...
						O,
						I;
						if (!N.collapsed) return t.execCommand("Delete"),
						void 0;
						if (!r.isDefaultPrevented() && (S = N.startContainer, T = N.startOffset, O = (a.force_p_newlines ? "p": "") || a.forced_root_block, O = O ? O.toUpperCase() : "", A = i.doc.documentMode, B = r.shiftKey, 1 == S.nodeType && S.hasChildNodes() && (I = T > S.childNodes.length - 1, S = S.childNodes[Math.min(T, S.childNodes.length - 1)] || S, T = I && 3 == S.nodeType ? S.nodeValue.length: 0), k = w(S))) {
							if (s.beforeChange(), !i.isBlock(k) && k != i.getRoot()) return (!O || B) && C(),
							void 0;
							if ((O && !B || !O && B) && (S = v(S, T)), R = i.getParent(S, i.isBlock), D = R ? i.getParent(R.parentNode, i.isBlock) : null, M = R ? R.nodeName.toUpperCase() : "", P = D ? D.nodeName.toUpperCase() : "", "LI" != P || r.ctrlKey || (R = D, M = P), "LI" == M) {
								if (!O && B) return C(),
								void 0;
								if (i.isEmpty(R)) return y(),
								void 0
							}
							if ("PRE" == M && a.br_in_pre !== !1) {
								if (!B) return C(),
								void 0
							} else if (!O && !B && "LI" != M || O && B) return C(),
							void 0;
							O && R === t.getBody() || (O = O || "P", g() ? (L = /^(H[1-6]|PRE|FIGURE)$/.test(M) && "HGROUP" != P ? m(O) : m(), a.end_container_on_empty_block && u(D) && i.isEmpty(R) ? L = i.split(D, R) : i.insertAfter(L, R), p(L)) : g(!0) ? (L = R.parentNode.insertBefore(m(), R), d(L), p(R)) : (E = N.cloneRange(), E.setEndAfter(R), H = E.extractContents(), x(H), L = H.firstChild, i.insertAfter(H, R), f(L), _(R), p(L)), i.setAttrib(L, "id", ""), t.fire("NewBlock", {
								newBlock: L
							}), s.add())
						}
					}
			...
			function(e, n, r) {
				...
				return function(n) {
					...
					m({
						...
						unlink: function(e) {
							w.isCollapsed() && w.select(w.getNode()),
							g(e),
							w.collapse(f)
						},
						"JustifyLeft,JustifyCenter,JustifyRight,JustifyFull": function(e) {
							var t = e.substring(7);
							"full" == t && (t = "justify"),
							i("left,center,right,justify".split(","),
							function(e) {
						...
						"InsertUnorderedList,InsertOrderedList": function(e) {
							var t, n;
							g(e),
							t = x.getParent(w.getNode(), "ol,ul"),
							t && (n = t.parentNode, /^(H[1-6]|P|ADDRESS|PRE)$/.test(n.nodeName) && (b(), x.split(n, t), C()))
						},
						...
						FontSize: function(e, t, n) {
							var r, i;
							n >= 1 && 7 >= n && (i = l(N.font_size_style_values), r = l(N.font_size_classes), n = r ? r[n - 1] || n: i[n - 1] || n),
							y(e, n)
						},
						...
						mceInsertContent: function(t, r, i) {
							...
							n.fire("BeforeSetContent", f),
							i = f.content,
							-1 == i.indexOf("{$caret}") && (i += "{$caret}"),
							i = i.replace(/\{\$caret\}/, v);
							var y = n.getBody();
							x.isBlock(y.firstChild) && x.isEmpty(y.firstChild) && (y.firstChild.appendChild(x.doc.createTextNode("\xa0")), w.select(y.firstChild, !0), x.remove(y.firstChild.lastChild)),
							w.isCollapsed() || n.getDoc().execCommand("Delete", !1, null),
							l = w.getNode();
							var b = {
								context: l.nodeName.toLowerCase()
							};
							if (d = a.parse(i, b), m = d.lastChild, "mce_marker" == m.attr("id")) for (p = m, m = m.prev; m; m = m.walk(!0)) if (3 == m.type || !x.isBlock(m.name)) {
								m.parent.insert(p, m, "br" === m.name);
								break
							}
							if (b.invalid) {
								for (w.setContent(v), l = w.getNode(), c = n.getBody(), 9 == l.nodeType ? l = m = c: m = l; m !== c;) l = m,
								m = m.parentNode;
								i = l == c ? c.innerHTML: x.getOuterHTML(l),
								i = s.serialize(a.parse(i.replace(/<span (id="mce_marker"|id=mce_marker).+?<\/span>/i,
								function() {
									return s.serialize(d)
								}))),
								l == c ? x.setHTML(c, i) : x.setOuterHTML(l, i)
							} else i = s.serialize(d),
							m = l.firstChild,
							g = l.lastChild,
							!m || m === g && "BR" === m.nodeName ? x.setHTML(l, i) : w.setContent(i);
							p = x.get("mce_marker"),
							w.scrollIntoView(p),
							h = x.createRng(),
							m = p.previousSibling,
							m && 3 == m.nodeType ? (h.setStart(m, m.nodeValue.length), u || (g = p.nextSibling, g && 3 == g.nodeType && (m.appendData(g.data), g.parentNode.removeChild(g)))) : (h.setStartBefore(p), h.setEndBefore(p)),
							x.remove(p),
							w.setRng(h),
							n.fire("SetContent", f),
							n.addVisual()
						...
						"Indent,Outdent": function(e) {
							...
							n = /[a-z%]+$/i.exec(t),
							t = parseInt(t, 10),
							p("InsertUnorderedList") || p("InsertOrderedList") ? g(e) : (N.forced_root_block || x.getParent(w.getNode(), x.isBlock) || E.apply("div"), i(w.getSelectedBlocks(),
							function(i) {
								var o;
						...
						mceRepaint: function() {
							if (c) try {
								b(d),
								w.getSel() && w.getSel().selectAllChildren(n.getBody()),
								w.collapse(d),
								C()
							} catch(e) {}
						},
			...
			function(e) {
				function t(e, i) {
					...
					return e = r(e),
					i = o.settings = i || {},
					/^([\w\-]+):([^\/]{2})/i.test(e) || /^\s*#/.test(e) ? (o.source = e, void 0) : (0 === e.indexOf("/") && 0 !== e.indexOf("//") && (e = (i.base_uri ? i.base_uri.protocol || "http": "http") + "://mce_host" + e), /^[\w\-]*:?\/\//.test(e) || (s = i.base_uri ? i.base_uri.path: new t(location.href).directory, e = (i.base_uri && i.base_uri.protocol || "http") + "://mce_host" + o.toAbsPath(s, e)), e = e.replace(/@@/g, "(mce_at)"), e = /^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@\/]*):?([^:@\/]*))?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/.exec(e), n(["source", "protocol", "authority", "userInfo", "user", "password", "host", "port", "relative", "path", "directory", "file", "query", "anchor"],
					function(t, n) {
						var r = e[n];
				...
				return t.prototype = {
					...
					getURI: function(e) {
						var t, n = this;
						return (!n.source || e) && (t = "", e || (n.protocol && (t += n.protocol + "://"), n.userInfo && (t += n.userInfo + "@"), n.host && (t += n.host), n.port && (t += ":" + n.port)), n.path && (t += n.path), n.query && (t += "?" + n.query), n.anchor && (t += "#" + n.anchor), n.source = t),
						n.source
					}
				},
				t
			...
			function(e, t, n, r) {
				...
				l = e.extend({
					...
					init: function(e) {
						...
						n.Defaults, e), n._id = r.id(), n._text = n._name = "", n._width = n._height = 0, n._aria = {
							role: e.role
						},
						i = e.classes) for (i = i.split(" "), i.map = {},
						o = i.length; o--;) i.map[i[o]] = !0;
						n._classes = i || [],
						n.visible(!0),
					...
					repaint: function() {
						...
						o = i.left + i.right,
						a = i.top + i.bottom,
						r.x !== s.x && (t.left = r.x + "px", s.x = r.x),
						r.y !== s.y && (t.top = r.y + "px", s.y = r.y),
						r.w !== s.w && (t.width = r.w - o + "px", s.w = r.w),
						r.h !== s.h && (t.height = r.h - a + "px", s.h = r.h),
						e._hasBody && r.innerW !== s.innerW && (n = e.getEl("body").style, n.width = r.innerW + "px", s.innerW = r.innerW),
						e._hasBody && r.innerH !== s.innerH && (n = n || e.getEl("body").style, n.height = r.innerH + "px", s.innerH = r.innerH),
					...
					on: function(e, t) {
						...
						var r = this,
						o, a, s, l;
						if (t) for ("string" == typeof t && (t = n(t)), s = e.toLowerCase().split(" "), l = s.length; l--;) e = s[l],
						o = r._bindings,
						o || (o = r._bindings = {}),
						a = o[e],
						a || (a = o[e] = []),
						a.push(t),
						i[e] && (r._nativeEvents ? r._nativeEvents[e] = !0 : r._nativeEvents = {
							name: !0
						},
					...
					off: function(e, t) {
						...
						if (i) if (e) for (s = e.toLowerCase().split(" "), r = s.length; r--;) {
							...
							if (o) if (t) for (l = o.length; l--;) o[l] === t && o.splice(l, 1);
							else o.length = 0
						} else n._bindings = [];
						return n
					},
					fire: function(e, t, n) {
						...
						var o = this,
						a, s, l, c;
						if (e = e.toLowerCase(), t = t || {},
						t.type || (t.type = e), t.control || (t.control = o), t.preventDefault || (t.preventDefault = function() {
					...
					innerHtml: function(e) {
						return r.innerHtml(this.getEl(), e),
						this
					},
					getEl: function(e, t) {
					...
					encode: function(e, t) {
						return t !== !1 && l.translate && (e = l.translate(e)),
						(e || "").replace(/[&<>"]/g,
						function(e) {
					...
					renderBefore: function(e) {
						var t = this;
						return e.parentNode.insertBefore(r.createFragment(t.renderHtml()), e),
						t.postRender(),
						t
					},
					renderTo: function(e) {
					...
					postRender: function() {
						...
						e._visible || r.css(e.getEl(), "display", "none"),
			...
			function(e, t, n, r, i, o) {
				...
				return e.extend({
					...
					focus: function() {
						var e = this;
						return e.keyNav ? e.keyNav.focusFirst() : e._super(),
						e
					},
					...
					create: function(t) {
						...
						function(t) {
							...
							n.settings.defaults, t), t.type = o.type = o.type || t.type || n.settings.defaultType || (o.defaults ? o.defaults.type: null), t = r.create(o)), a.push(t))
						}),
						a
					},
					renderNew: function() {
					...
					renderHtml: function() {
						...
						return e.preRender(),
						t.preRender(e),
						'<div id="' + e._id + '" class="' + e.classes() + '" role="' + this.settings.role + '">' + '<div id="' + e._id + '-body" class="' + e.classes("body") + '">' + (e.settings.html || "") + t.renderHtml(e) + "</div>" + "</div>"
					},
					postRender: function() {
						var e = this,
						t;
					...
					reflow: function() {
						...
						if (this.visible()) {
							...
							n = this.recalc(), t = e.repaintControls.length; t--;) e.repaintControls[t].repaint();
						...
						function n() {
							function t(t, a, s, l, c, u) {
								...
								if (f = i.getEl("scroll" + t)) {
									if (y = a.toLowerCase(), b = s.toLowerCase(), i.getEl("absend") && e.css(i.getEl("absend"), y, i.layoutRect()[l] - 1), !c) return e.css(f, "display", "none"),
									void 0;
			...
			function(e, t) {
				return e.extend({
					...
					renderHtml: function() {
						...
						'<div id="' + e._id + '" class="' + e.classes() + '" hideFocus="1" tabIndex="-1">' + (e._preBodyHtml || "") + n + "</div>"
					}
				})
			}),
			r(G, [W],
			...
			function(e, t, n, r) {
				...
				u = e.extend({
					...
					init: function(e) {
						function t() {
							...
							n;
							if (l.length) for (e = 0; e < l.length; e++) l[e].modal && (t++, n = l[e]),
							l[e].getEl().style.zIndex = t,
							l[e].zIndex = t,
							t++;
						...
						d._super(e),
						d._eventsRoot = d,
						d.addClass("floatpanel"),
						e.autohide && (o || (o = function(e) {
						...
						r.on(document, "click", o)), s.push(d)),
						e.autofix && (a || (a = function() {
							var e;
							for (e = s.length; e--;) i(s[e])
						},
						r.on(window, "scroll", a)), d.on("move",
						function() {
							i(this)
						})),
						d.on("postrender show",
						function(e) {
							if (e.control == d) {
				...
				return u.hideAll = function() {
					for (var e = s.length; e--;) {
						var t = s[e];
						t.settings.autohide && (t.fire("cancel", {},
						!1), t.hide(), s.splice(e, 1))
					}
				},
				u
			}),
			...
			function(e) {
				return function(t) {
					...
					function c(e) {
						...
						i += e,
						0 > i ? i = l.length - 1 : i >= l.length && (i = 0),
						o = l[i],
						o.focus(),
						m = o.id,
						t.actOnFocus && s()
			...
			function(e, t, n, r, i) {
				var o = e.extend({
					...
					renderHtml: function() {
						...
						return e.preRender(),
						t.preRender(e),
						i.title && (o = '<div id="' + n + '-head" class="' + r + 'window-head">' + '<div class="' + r + 'title">' + e.encode(i.title) + "</div>" + '<button type="button" class="' + r + 'close" aria-hidden="true">&times;</button>' + '<div id="' + n + '-dragh" class="' + r + 'dragh"></div>' + "</div>"),
						i.url && (s = '<iframe src="' + i.url + '" tabindex="-1"></iframe>'),
						"undefined" == typeof s && (s = t.renderHtml(e)),
						e.statusbar && (a = e.statusbar.renderHtml()),
						'<div id="' + n + '" class="' + e.classes() + '" hideFocus="1" tabIndex="-1">' + o + '<div id="' + n + '-body" class="' + e.classes("body") + '">' + s + "</div>" + a + "</div>"
					},
			...
			function(e, t) {
				return function(n) {
					...
					i.open = function(t, r) {
						...
						i.params = r || {},
						n.nodeChanged(),
						i.renderTo(document.body).reflow()
					},
			...
			function(e, t, n, r, i, o) {
				return function(a) {
					...
					function u() {
						function t(e) {
							...
							if (n.collapsed || (e = !0), l = n[(e ? "start": "end") + "Container"], c = n[(e ? "start": "end") + "Offset"], 3 == l.nodeType && (r = z.getParent(n.startContainer, z.isBlock), e && (r = z.getNext(r, z.isBlock)), !r || !t() && n.collapsed || (i = z.create("em", {
								id: "__mceDel"
							}), O(o.grep(r.childNodes),
							function(e) {
								i.appendChild(e)
							}), r.appendChild(i))), n = z.createRng(), n.setStart(d[0], d[1]), n.setEnd(d[2], d[3]), W.setRng(n), a.getDoc().execCommand(e ? "ForwardDelete": "Delete", !1, null), i) {
								for (s = W.getBookmark(); u = z.get("__mceDel");) z.remove(u, !0);
								W.moveToBookmark(s)
							}
						}
						a.on("keydown",
						function(n) {
							var r;
							r = n.keyCode == F,
							c(n) || !r && n.keyCode != I || e.modifierPressed(n) || (n.preventDefault(), t(r))
						}),
						a.addCommand("Delete",
						function() {
							t()
					...
					function d() {
						...
						function(e) {
							...
							if (!c(e) && (n == F || n == I)) {
								...
								e.preventDefault(),
								a.setContent(""),
								a.selection.setCursorLocation(a.getBody(), 0),
								a.nodeChanged()
							}
						})
					}
					function f() {
						a.on("keydown",
						function(t) { ! c(t) && 65 == t.keyCode && e.metaKeyPressed(t) && (t.preventDefault(), a.execCommand("SelectAll"))
						})
					}
					function p() {
						a.settings.content_editable || (z.bind(a.getDoc(), "focusin",
						function() {
							W.setRng(W.getRng())
						}), z.bind(a.getDoc(), "mousedown",
						function(e) {
					...
					function h() {
						...
						function(e) {
							if (!c(e) && e.keyCode === I && W.isCollapsed() && 0 === W.getRng(!0).startOffset) {
								var t = W.getNode(),
								n = t.previousSibling;
								if ("HR" == t.nodeName) return z.remove(t),
								e.preventDefault(),
								void 0;
					...
					function g() {
						...
						function(e) {
							e = e.target,
							/^(IMG|HR)$/.test(e.nodeName) && W.getSel().setBaseAndExtent(e, 0, e, 1),
							"A" == e.nodeName && z.hasClass(e, "mce-item-anchor") && W.select(e),
							a.nodeChanged()
						})
					}
					function v() {
						function e() {
							...
							return function() {
								var t = W.getStart();
								t !== a.getBody() && (z.setAttrib(t, "style", null), O(e,
								function(e) {
					...
					function x() {
						l() > 7 || (s("RespectVisibilityInDesign", !0), a.contentStyles.push(".mceHideBrInPre pre br {display: none}"), z.addClass(a.getBody(), "mceHideBrInPre"), U.addNodeFilter("pre",
						function(e) {
							for (var t = e.length,
					...
					function _() {
						...
						function(t) {
							var n, r, i, o, s, l, u, d;
							if (n = t.keyCode == F, !c(t) && (n || t.keyCode == I) && !e.modifierPressed(t) && (r = W.getRng(), i = r.startContainer, o = r.startOffset, u = r.collapsed, 3 == i.nodeType && i.nodeValue.length > 0 && (0 === o && !u || u && o === (n ? 0 : 1)))) {
								...
								a.getDoc().execCommand(n ? "ForwardDelete": "Delete", !1, null),
								i = W.getRng().startContainer,
								l = i.previousSibling,
								l && 1 == l.nodeType && !z.isBlock(l) && z.isEmpty(l) && !d[l.nodeName.toLowerCase()] && z.remove(l),
								z.remove("__tmp")
							}
						})
					}
					...
					function E() {
						function e() {
							...
							V.object_resizing || s("enableObjectResizing", !1)
						}
					...
					function A() {
						var e;
						l() >= 10 && (e = "", O("p div h1 h2 h3 h4 h5 h6".split(" "),
						function(t, n) {
							e += (n > 0 ? ",": "") + t + ":empty"
						}), a.contentStyles.push(e + "{padding-right: 1px !important}"))
					}
					function B() {
						l() < 9 && (U.addNodeFilter("noscript",
						function(e) {
							for (var t = e.length,
							n, r; t--;) n = e[t],
							r = n.firstChild,
							r && n.attr("data-mce-innertext", r.value)
						}), q.addNodeFilter("noscript",
						function(e) {
							for (var t = e.length,
							i, o, a; t--;) i = e[t],
							o = e[t].firstChild,
					...
					function L() {
						...
						z.bind(r, "mousedown contextmenu",
						function(i) {
							if ("HTML" === i.target.nodeName) {
								if (o && n(), s = r.documentElement, s.scrollHeight > s.clientHeight) return;
								o = 1,
								a = e(i.x, i.y),
								a && (z.bind(r, "mouseup", n), z.bind(r, "mousemove", t), z.win.focus(), a.select())
							}
						})
					}
					function H() {
					...
					d(),
					H(),
					K && (_(), u(), p(), g(), S(), i.iOS ? (y(), M()) : f()),
					j && i.ie < 11 && (h(), b(), x(), w(), R(), A(), B(), L()),
					i.ie >= 11 && P(),
					$ && (h(), m(), v(), E(), k(), T(), D())
				}
			}),
			...
			function(e) {
				...
				return {
					fire: function(e, i, o) {
						...
						i.type = e, i.target || (i.target = a), i.preventDefault || (i.preventDefault = function() {
						...
						i.isDefaultPrevented = t, i.isPropagationStopped = t, i.isImmediatePropagationStopped = t), a[r] && (s = a[r][e])) for (l = 0, c = s.length; c > l && (s[l] = u = s[l], !i.isImmediatePropagationStopped()); l++) if (u.call(a, i) === !1) return i.preventDefault(),
						i;
					...
					on: function(e, t) {
						...
						if (t === !1 && (t = function() {
							return ! 1
						}), t) for (s = e.toLowerCase().split(" "), l = s.length; l--;) e = s[l],
						o = n[r],
						o || (o = n[r] = {}),
						a = o[e],
						a || (a = o[e] = [], n.bindNative && i[e] && n.bindNative(e)),
						a.push(t);
						return n
					},
					off: function(e, t) {
						...
						if (a) if (e) for (c = e.toLowerCase().split(" "), o = c.length; o--;) {
							...
							if (s) {
								if (t) for (u = s.length; u--;) s[u] === t && s.splice(u, 1);
			...
			function(e, t) {
				...
				return function(o) {
					...
					function(e) { (e.altKey || e.ctrlKey || e.metaKey) && n(s,
						function(n) {
			...
			r(it, [v, b, C, k, E, A, L, H, D, M, P, O, y, l, et, x, _, tt, g, p, nt, rt],
			function(e, n, r, i, o, a, s, l, c, u, d, f, p, h, m, g, v, y, b, C, x, w) {
				function _(e, t) {
				...
				function N(e, t, r) {
					var i = this,
					o, a;
					o = i.documentBaseUrl = r.documentBaseURL,
					a = r.baseURI,
					i.settings = t = T({
						id: e,
						theme: "modern",
					...
					i.isNotDirty = !0,
					i.plugins = {},
					i.documentBaseURI = new f(t.document_base_url || o, {
						base_uri: a
					}),
					i.baseURI = a,
					i.contentCSS = [],
				...
				return N.prototype = {
					render: function() {
						...
						function t() {
							...
							C.isArray(r.plugins) && (r.plugins = r.plugins.join(" ")),
							R(r.external_plugins,
							function(e, t) {
								S.load(t, e),
								r.plugins += " " + t
							}),
						...
						i = n.id,
						o = n.suffix;
						if (!D.domLoaded) return E.bind(window, "ready", e),
						void 0;
						if (n.getElement() && b.contentEditable) {
							...
							E.bind(a, "submit reset", n.formEventDelegate), n.on("reset",
							function() {
					...
					init: function() {
						function e(n) {
							...
							i,
							o;
							i = S.urls[n] || t.documentBaseUrl.replace(/\/$/, ""),
							n = L(n),
							r && -1 === B(h, n) && (R(S.dependencies(n),
							function(t) {
								e(t)
						...
						if (t.rtl = this.editorManager.i18n.rtl, t.editorManager.add(t), n.aria_label = n.aria_label || E.getAttrib(r, "aria-label", t.getLang("aria.rich_text_area")), n.theme && ("function" != typeof n.theme ? (n.theme = n.theme.replace(/-/, ""), l = k.get(n.theme), t.theme = new l(t, k.urls[n.theme]), t.theme.init && t.theme.init(t, k.urls[n.theme] || t.documentBaseUrl.replace(/\/$/, ""))) : t.theme = n.theme), R(n.plugins.replace(/\-/g, "").split(/[ ,]/), e), t.fire("BeforeRenderUI"), n.render_ui && t.theme && (t.orgDisplay = r.style.display, "function" != typeof n.theme ? (i = n.width || r.style.width || r.offsetWidth, o = n.height || r.style.height || r.offsetHeight, a = n.min_height || 100, f = /^[0-9\.]+(|px)$/i, f.test("" + i) && (i = Math.max(parseInt(i, 10) + (l.deltaWidth || 0), 100)), f.test("" + o) && (o = Math.max(parseInt(o, 10) + (l.deltaHeight || 0), a)), l = t.theme.renderUI({
							...
							wi2dth: i,
							h2eight: o
						}), o = (l.iframeHeight || o) + ("number" == typeof o ? l.deltaHeight || 0 : ""), a > o && (o = a))) : (l = n.theme(t, r), l.editorContainer.nodeType && (l.editorContainer = l.editorContainer.id = l.editorContainer.id || t.id + "_parent"), l.iframeContainer.nodeType && (l.iframeContainer = l.iframeContainer.id = l.iframeContainer.id || t.id + "_iframecontainer"), o = l.iframeHeight || r.offsetHeight), t.editorContainer = l.editorContainer), n.content_css && R(A(n.content_css),
						function(e) {
						...
						for (t.iframeHTML = n.doctype + "<html><head>", n.document_base_url != t.documentBaseUrl && (t.iframeHTML += '<base href="' + t.documentBaseURI.getURI() + '" />'), !b.caretAfter && n.ie7_compat && (t.iframeHTML += '<meta http-equiv="X-UA-Compatible" content="IE=7" />'), t.iframeHTML += '<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />', p = 0; p < t.contentCSS.length; p++) {
							...
							t.iframeHTML += '<link type="text/css" rel="stylesheet" href="' + m + '" />',
							t.loadedCSS[m] = !0
						}
						u = n.body_id || "tinymce",
						-1 != u.indexOf("=") && (u = t.getParam("body_id", "", "hash"), u = u[t.id] || u),
						d = n.body_class || "",
						-1 != d.indexOf("=") && (d = t.getParam("body_class", "", "hash"), d = d[t.id] || ""),
						t.iframeHTML += '</head><body id="' + u + '" class="mce-content-body ' + d + '" ' + "onload=\"window.parent.tinymce.get('" + t.id + "').fire('load');\"><br></body></html>";
						...
						l.editorContainer && (E.get(l.editorContainer).style.display = t.orgDisplay),
						E.get(t.id).style.display = "none",
						E.setAttrib(t.id, "aria-hidden", !0),
						c || t.initContentBody(),
						r = s = l = null
					},
					initContentBody: function(t) {
						...
						h,
						m;
						o.inline || (n.getElement().style.visibility = n.orgVisibility),
						t || o.content_editable || (p.open(), p.write(n.iframeHTML), p.close()),
						o.content_editable && (n.on("remove",
						function() {
							var e = this.getBody();
							E.removeClass(e, "mce-content-body"),
							E.removeClass(e, "mce-edit-focus"),
							E.setAttrib(e, "tabIndex", null),
							E.setAttrib(e, "contentEditable", null)
						}), E.addClass(f, "mce-content-body"), f.tabIndex = -1, n.contentDocument = p = o.content_document || document, n.contentWindow = o.content_window || window, n.bodyElement = f, o.content_document = o.content_window = null, o.root_name = f.nodeName.toLowerCase()),
						h = n.getBody(),
						h.disabled = !0,
						o.readonly || (n.inline && "static" == E.getStyle(h, "position", !0) && (h.style.position = "relative"), h.contentEditable = n.getParam("content_editable_state", !0)),
						h.disabled = !1,
						n.schema = new g(o),
						n.dom = new e(p, {
							keep_values: !0,
						...
						function(e, t) {
							...
							a = i.attr(t),
							s = "data-mce-" + t,
							i.attributes.map[s] || ("style" === t ? i.attr(s, o.serializeStyle(o.parseStyle(a), i.name)) : i.attr(s, n.convertURL(a, t, i.name)))
						}),
						...
						function(e) {
							for (var t = e.length,
							i, o = n.schema.getNonEmptyElements(); t--;) i = e[t],
							i.isEmpty(o) && (i.empty().append(new r("br", 1)).shortEnded = !0)
						}),
						n.serializer = new i(o, n),
						n.selection = new a(n.dom, n.getWin(), n.serializer, n),
						n.formatter = new s(n),
						n.undoManager = new l(n),
						n.forceBlocks = new u(n),
						n.enterKey = new c(n),
						n.editorCommands = new d(n),
						n.fire("PreInit"),
						o.browser_spellcheck || o.gecko_spellcheck || (p.body.spellcheck = !1, E.setAttrib(h, "spellcheck", "false")),
						n.fire("PostRender"),
						n.quirks = y(n),
						o.directionality && (h.dir = o.directionality),
						o.nowrap && (h.style.whiteSpace = "nowrap"),
						o.protect && n.on("BeforeSetContent",
						function(e) {
							R(o.protect,
							function(t) {
						...
						o.padd_empty_editor && n.on("PostProcess",
						function(e) {
						...
						n.contentStyles.length > 0 && (m = "", R(n.contentStyles,
						function(e) {
							m += e + "\r\n"
						}), n.dom.addStyle(m)),
						R(n.contentCSS,
					...
					focus: function(e) {
						...
						o, a, s = n.getDoc(),
						l;
						e || (o = r.getRng(), o.item && (a = o.item(0)), n._refreshContentEditable(), i || (b.opera || n.getBody().focus(), n.getWin().focus()), (M || i) && (l = n.getBody(), l.setActive && b.ie < 11 ? l.setActive() : l.focus(), i && r.normalize()), a && a.ownerDocument == s && (o = s.body.createControlRange(), o.addElement(a), o.select())),
					...
					getParam: function(e, t, n) {
						...
						i;
						return "hash" === n ? (i = {},
						"string" == typeof r ? R(r.indexOf("=") > 0 ? r.split(/[;,](?![^=;,]*(?:[;,]|$))/) : r.split(","),
						function(e) {
							e = e.split("="),
							i[L(e[0])] = e.length > 1 ? L(e[1]) : L(e)
						}) : i = r, i) : r
					},
					nodeChanged: function() {
						...
						t = e.selection,
						n, r, i;
						e.initialized && !e.settings.disable_nodechange && (i = e.getBody(), n = t.getStart() || i, n = P && n.ownerDocument != e.getDoc() ? e.getBody() : n, "IMG" == n.nodeName && t.isCollapsed() && (n = n.parentNode), r = [], e.dom.getParent(n,
						function(e) {
					...
					hide: function() {
						var e = this,
						t = e.getDoc();
						P && t && t.execCommand("SelectAll"),
						e.save(),
						E.hide(e.getContainer()),
					...
					save: function(e) {
						...
						r = e.content,
						/TEXTAREA|INPUT/i.test(n.nodeName) ? n.value = r: (n.innerHTML = r, (i = E.getParent(t.id, "form")) && R(i.elements,
						function(e) {
					...
					setContent: function(e, t) {
						...
						e = t.content,
						0 === e.length || /^\s+$/.test(e) ? (i = n.settings.forced_root_block, i && n.schema.isValidChild(r.nodeName.toLowerCase(), i.toLowerCase()) ? (e = P && 11 > P ? "": '<br data-mce-bogus="1">', e = n.dom.createHTML(i, n.settings.forced_root_block_attrs, e)) : (!P || 11 > P) && (e = '<br data-mce-bogus="1">'), r.innerHTML = e, n.fire("SetContent", t)) : ("raw" !== t.format && (e = new o({},
					...
					addVisual: function(e) {
						...
						function(e) {
							...
							case "TABLE":
								...
								t && "0" != t || (n.hasVisual ? i.addClass(e, o) : i.removeClass(e, o)),
								void 0;
							case "A":
								return i.getAttrib(e, "href", !1) || (t = i.getAttrib(e, "name") || e.id, o = "mce-item-anchor", t && (n.hasVisual ? i.addClass(e, o) : i.removeClass(e, o))),
								void 0
							}
						}),
						n.fire("VisualAid", {
					...
					remove: function() {
						...
						if (!e.removed) {
							e.removed = 1,
							e.hasHiddenInput && E.remove(e.getElement().nextSibling);
							var t = e.getDoc();
							P && t && t.execCommand("SelectAll"),
							e.save(),
							E.setStyle(e.id, "display", e.orgDisplay),
							e.settings.content_editable || (D.unbind(e.getWin()), D.unbind(e.getDoc()));
					...
					bindNative: function(e) {
						var t = this;
						t.settings.readonly || (t.initialized ? t.dom.bind(_(t, e), e,
						function(n) {
							t.fire(e, n)
					...
					destroy: function(e) {
						...
						n;
						if (!t.destroyed) {
							if (!e && !t.removed) return t.remove(),
							void 0;
							e && M && (D.unbind(t.getDoc()), D.unbind(t.getWin()), D.unbind(t.getBody())),
							...
							n = t.formElement,
							n && (n._mceOldSubmit && (n.submit = n._mceOldSubmit, n._mceOldSubmit = null), E.unbind(n, "submit reset", t.formEventDelegate)),
			...
			function(e, t) {
				function n(r) {
					...
					function s(s) {
						...
						c.on("init",
						function() {
							"onbeforedeactivate" in document && t.ie < 11 ? c.dom.bind(c.getBody(), "beforedeactivate",
							function() {
								var e = c.getDoc().selection;
								try {
									u = e && e.createRange ? e.createRange() : c.selection.getRng()
								} catch(t) {}
							}) : (c.inline || t.ie > 10) && (c.on("nodechange keyup",
							function() {
							...
							e.DOM.bind(document, "selectionchange", d), c.on("remove",
							function() {
						...
						function() {
							...
							c.selection.lastFocusBookmark && (c.selection.setRng(a(c, c.selection.lastFocusBookmark)), c.selection.lastFocusBookmark = null),
							e != c && (e && e.fire("blur", {
								focusedEditor: c
						...
						c.on("focusout",
						function() {
							c.selection.lastFocusBookmark = o(u),
							window.setTimeout(function() {
								var e = r.focusedEditor;
								e != c && (c.selection.lastFocusBookmark = null),
								l(i()) || e != c || (c.fire("blur", {
									focusedEditor: null
			...
			function(e, n, r, i, o, a, s, l) {
				...
				h, m = {
					...
					setup: function() {
						...
						t, n, i = "",
						o;
						if (n = document.location.href.replace(/[\?#].*$/, "").replace(/[\/\\][^\/]+$/, ""), /[\/\\]$/.test(n) || (n += "/"), o = window.tinymce || window.tinyMCEPreInit) t = o.base || o.baseURL,
						i = o.suffix;
						else for (var a = document.getElementsByTagName("script"), s = 0; s < a.length; s++) {
							var c = a[s].src;
							if (/tinymce(\.jquery|)(\.min|\.dev|)\.js/.test(c)) { - 1 != c.indexOf(".min") && (i = ".min"),
								t = c.substring(0, c.lastIndexOf("/"));
								break
							}
						}
					...
					init: function(t) {
						...
						function o() {
							var h, m;
							if (c.unbind(window, "ready", o), r(t, "onpageload"), t.types) return d(t.types,
							function(r) {
								d(c.select(r.selector),
								function(i) {
									var o = new e(n(i), f({},
									t, r), a);
									s.push(o),
							...
							void 0;
							if (t.selector) return d(c.select(t.selector),
							function(r) {
								var i = new e(n(r), t, a);
								s.push(i),
								i.render(1)
							...
							case "exact":
								...
								h.length > 0 && d(u(h),
								function(n) {
									c.get(n) ? (l = new e(n, t, a), s.push(l), l.render(!0)) : d(document.forms,
									function(r) {
										d(r.elements,
										function(r) {
					...
					remove: function(e) {
						...
						i, o; {
							if (e) {
								if ("string" == typeof e) return e = e.selector || e,
								d(c.select(e),
								function(e) {
									t.remove(r[e.id])
								}),
								...
								return t.activeEditor == i && (t.activeEditor = r[0]),
								o && t.fire("RemoveEditor", {
									editor: i
								}),
								r.length || c.unbind(window, "beforeunload", h),
								i.remove(),
								i
							}
				...
				return f(m, a),
				m.setup(),
				window.tinymce = window.tinyMCE = m,
				m
			}),
			r(lt, [st, p],
			function(e, t) {
			...
			function() {
				return {
					send: function(e) {
						function t() { ! e.async || 4 == n.readyState || r++>1e4 ? (e.success && 1e4 > r && 200 == n.status ? e.success.call(e.success_scope, "" + n.responseText, n, e) : e.error && e.error.call(e.error_scope, r > 1e4 ? "TIMED_OUT": "GENERAL", n, e), n = null) : setTimeout(t, 10)
						}
						var n, r = 0;
			...
			function(e, t) {
				var n, r = e.extend({
					init: function(e) {
						...
						t._super(e),
						t.canFocus = !0,
						e.tooltip && r.tooltips !== !1 && t.on("mouseenter mouseleave",
						function(n) {
					...
					postRender: function() {
						...
						t.autofocus && setTimeout(function() {
							e.focus()
						},
						0)
					},
			...
			function(e) {
				return e.extend({
					...
					renderHtml: function() {
						...
						'<div id="' + t + '" class="' + e.classes() + '" tabindex="-1">' + '<button role="presentation" type="button" tabindex="-1">' + (r ? '<i class="' + r + '"' + i + "></i>": "") + (e._text ? (r ? "\xa0": "") + e.encode(e._text) : "") + "</button>" + "</div>"
					}
				})
			}),
			r(Ct, [q],
			...
			function(e, t) {
				return e.extend({
					init: function(e) {
						...
						function() {
							n._hasOnChange || (t.on(n.getEl("inp"), "change",
							function() {
								n.fire("change")
							}), n._hasOnChange = !0),
							n.hasClass("placeholder") && (n.getEl("inp").value = "", n.removeClass("placeholder"))
						}), n.on("focusout",
						function() {
					...
					postRender: function() {
						var e = this;
						return t.on(this.getEl("inp"), "change",
						function() {
							e.fire("change")
						}),
						e._super()
					...
					renderHtml: function() {
						...
						o, a, s = "";
						return o = n.icon ? r + "ico " + r + "i-" + n.icon: "",
						a = e._text,
						(o || a) && (s = '<div id="' + t + '-open" class="' + r + "btn " + r + 'open" tabIndex="-1">' + '<button id="' + t + '-action" type="button" hidefocus tabindex="-1">' + (o ? '<i class="' + o + '"></i>': '<i class="' + r + 'caret"></i>') + (a ? (o ? " ": "") + a: "") + "</button>" + "</div>", e.addClass("has-open")),
						'<div id="' + t + '" class="' + e.classes() + '">' + '<input id="' + t + '-inp" class="' + r + "textbox " + r + 'placeholder" value="' + i + '" hidefocus="true"' + (e.disabled() ? ' disabled="disabled"': "") + ">" + s + "</div>"
					}
				})
			}),
			r(Et, [yt, J],
			function(e, t) {
				return e.extend({
					...
					_getPathHtml: function() {
						...
						return i || (i = '<div class="' + o + 'path-item">&nbsp;</div>'),
						i
					}
				})
			}),
				...
				return e.extend({
					postRender: function() {
						...
						function(t) {
							...
							i,
							o = r.getBody();
							for (r.focus(), i = r.selection.getStart(); i && i != o;) e(i) || n.push(i),
							i = i.parentNode;
							r.selection.select(n[n.length - 1 - t.index]),
							r.nodeChanged()
						}),
						r.on("nodeChange",
						function(t) {
			...
			function(e) {
				return e.extend({
					init: function(e) {
						...
						r && (e.icon = "browse", e.onaction = function() {
			...
			function(e) {
				return e.extend({
					recalc: function(e) {
						...
						y > _ && (_ = y);
						if (x = {},
						x[E] = 0 > d ? i[E] - d + i[B] : i[R] - d + i[B], x[P] = _ + i[z], x[L] = i[R] - d, x[W] = _, x.minW = U(x.minW, i.maxW), x.minH = U(x.minH, i.maxH), x.minW = V(x.minW, i.startMinWidth), x.minH = V(x.minH, i.startMinHeight), !i.autoResize || x.minW == i.minW && x.minH == i.minH) {
							for (C = d / u, t = 0, n = v.length; n > t; t++) p = v[t],
							h = p.layoutRect(),
							b = h[S],
							y = h[E] + Math.ceil(h.flex * C),
							y > b ? (d -= h[S] - h[E], u -= h.flex, h.flex = 0, h.maxFlexSize = b) : h.maxFlexSize = 0;
							for (C = d / u, w = o[T], x = {},
							0 === u && ("end" == l ? w = d + o[T] : "center" == l ? (w = Math.round(i[R] / 2 - (i[R] - d) / 2) + o[T], 0 > w && (w = o[T])) : "justify" == l && (w = o[T], c = Math.floor(d / (r.length - 1)))), x[H] = o[I], t = 0, n = r.length; n > t; t++) p = r[t],
							h = p.layoutRect(),
							y = h.maxFlexSize || h[E],
							"center" === s ? x[H] = Math.round(i[D] / 2 - h[M] / 2) : "stretch" === s ? (x[M] = V(h[P] || 0, i[D] - o[I] - o[F]), x[H] = o[I]) : "end" === s && (x[H] = i[D] - h[M] - o.top),
							h.flex > 0 && (y += Math.ceil(h.flex * C)),
							x[N] = y,
							x[k] = w,
							p.layoutRect(x),
							p.recalc && p.recalc(),
			...
			function(e, t, n, r, i, o) {
				function a(e) {
					function t(t) {
						...
						a = "",
						l, c;
						return c = e.settings.preview_styles,
						c === !1 ? "": (c || (c = "font-family font-size font-weight text-decoration text-transform color background-color border border-radius"), (t = e.formatter.get(t)) ? (t = t[0], r = t.block || t.inline || "span", i = o.create(r), s(t.styles,
						function(e, t) {
							e = n(e),
							e && o.setStyle(i, t, e)
						}), s(t.attributes,
						...
						function(e) {
							e = n(e),
							o.hasClass(i, e) || o.addClass(i, e)
						}), e.fire("PreviewFormats"), o.setStyles(i, {
							position: "absolute",
							left: -65535
						}), e.getBody().appendChild(i), l = o.getStyle(e.getBody(), "fontSize", !0), l = /px$/.test(l) ? parseInt(l, 10) : 0, s(c.split(" "),
						function(t) {
					...
					function c() {
						var t = this;
						t.disabled(!a()),
						e.on("Undo Redo AddUndo TypingUndo",
						function() {
							t.disabled(!a())
						})
					}
				...
				return e.extend({
					recalc: function(e) {
						...
						l.minW = w + (o.w - o.innerW), l.minH = _ + (o.h - o.innerH), l.contentW = l.minW - o.deltaW, l.contentH = l.minH - o.deltaH, l.minW = Math.min(l.minW, o.maxW), l.minH = Math.min(l.minH, o.maxH), l.minW = Math.max(l.minW, o.startMinWidth), l.minH = Math.max(l.minH, o.startMinHeight), !o.autoResize || l.minW == o.minW && l.minH == o.minH) {
							...
							var H = 0,
							D = t.flexWidths;
							if (D) for (d = 0; d < D.length; d++) H += D[d];
							else H = r;
							var M = A / H;
							for (d = 0; r > d; d++) N[d] += D ? Math.ceil(D[d] * M) : M;
			...
			function(e, t, n) {
				...
				var i = e.extend({
					...
					renderHtml: function() {
						...
						'<div id="' + t + '" class="' + e.classes() + '" tabindex="-1">' + '<button id="' + t + '-open" role="presentation" type="button" tabindex="-1">' + (i ? '<i class="' + i + '"></i>': "") + "<span>" + (e._text ? (i ? "\xa0": "") + e.encode(e._text) : "") + "</span>" + ' <i class="' + r + 'caret"></i>' + "</button>" + "</div>"
					},
					postRender: function() {
						var e = this;
						return e.on("click",
				...
				return e.extend({
					init: function(e) {
						...
						if (t._values = n = e.values, n) {
							for (r = 0; r < n.length; r++) i = n[r].selected || e.value === n[r].value,
							i && (o = o || n[r].text, t._value = n[r].value);
							e.menu = n
						}
						e.text = e.text || o || n[0].text,
						t._super(e),
						t.addClass("listbox"),
						t.on("select",
						function(n) {
					...
					value: function(e) {
						...
						if ("undefined" != typeof e) {
							...
							else for (o = n.settings.menu, a = 0; a < o.length; a++) r = o[a].value == e,
							r && (i = i || o[a].text),
							o[a].active = r;
			...
			function(e, t) {
				return e.extend({
					...
					init: function(e) {
						...
						("-" === t._text || "|" === t._text) && (t.addClass("menu-item-sep"), t.aria("role", "separator"), t.canFocus = !1, t._text = "-"),
						e.selectable && (t.aria("role", "menuitemcheckbox"), t.aria("checked", !0), t.addClass("menu-item-checkbox"), e.icon = "selected"),
					...
					showMenu: function() {
						...
						if (i.items().each(function(t) {
							...
							r ? r.show() : (r = n.menu, r.length ? r = {
								type: "menu",
								items: r
							}: r.type = r.type || "menu", i.settings.itemDefaults && (r.itemDefaults = i.settings.itemDefaults), r = e.menu = t.create(r).parent(e).renderTo(e.getContainerElm()), r.reflow(), r.fire("show"), r.on("cancel",
							function() {
								e.focus()
							}), r.on("hide",
							function(t) {
					...
					renderHtml: function() {
						...
						n.image && (o = "none", a = " style=\"background-image: url('" + n.image + "')\""),
						o = r + "ico " + r + "i-" + (e.settings.icon || "none"),
						'<div id="' + t + '" class="' + e.classes() + '" tabindex="-1">' + ("-" !== i ? '<i class="' + o + '"' + a + "></i>&nbsp;": "") + ("-" !== i ? '<span id="' + t + '-text" class="' + r + 'text">' + i + "</span>": "") + (n.shortcut ? '<div id="' + t + '-shortcut" class="' + r + 'menu-shortcut">' + n.shortcut + "</div>": "") + (n.menu ? '<div class="' + r + 'caret"></div>': "") + "</div>"
					},
					postRender: function() {
						var e = this,
						t = e.settings,
			...
			function(e, t, n, r) {
				var i = e.extend({
					...
					init: function(e) {
						var i = this;
						if (e.autohide = !0, e.constrainToViewport = !0, e.itemDefaults) for (var o = e.items,
						a = o.length; a--;) o[a] = r.extend({},
						e.itemDefaults, o[a]);
						i._super(e),
						i.addClass("menu"),
						i.keyNav = new t({
					...
					postRender: function() {
						...
						function(e) {
							...
							if (e.control == this) for (; n;) {
								if ("BUTTON" == n.nodeName && -1 == n.className.indexOf("open")) return e.stopImmediatePropagation(),
								t.call(this, e),
								void 0;
								n = n.parentNode
							}
			...
			function(e, t) {
				return e.extend({
					...
					activateTab: function(e) {
						...
						e != this.lastIdx && (this.items()[this.lastIdx].hide(), this.lastIdx = e),
